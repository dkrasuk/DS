...
(function ($) {
    ...
    $.fn.fogLoader = function (opts) {
        ...
        $(this).each(function () {
            ...
            var ttlbar = $(this).parent().find('.ui-dialog-titlebar');
            ...
            $(this).parent().css({padding: '0',borderWidth: stgs.border.width});
            if (stgs.border.radius) {
                $(this).parent().find('.ui-dialog, .ui-dialog-titlebar').css({'-moz-border-radius': stgs.border.radius,'-webkit-border-radius': stgs.border.radius });
            };
            if (stgs.style == 'progressbar') {
                ...
                $(this).parent().find('.ui-widget-content').css('border-width', '0px');
            ...
            if (stgs.animated && stgs.style != 'progressbar') {
                ...
                if(stgs.spell){
                    $(this).parent().find('.ui-dialog-title').html(stgs.message.substring(0,1));
                }
                _interval = setInterval(function () {
                    var spellmsg = $(this).parent().find('.ui-dialog-title').html();
                    if (!spellmsg) {
                        clearInterval(_interval);
                    } else {
                        ...
                        $(this).parent().find('.ui-dialog-title').html(spellmsg);
                    }
                }, stgs.progress.delay);
            };
