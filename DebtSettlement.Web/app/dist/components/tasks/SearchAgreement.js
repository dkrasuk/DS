    ...
    $(function () {
        ...
        $("#btnStartSearch").click(function () {
            ...
            $("#agreementSearchTable").dataTable({
                columns: [{ data: "AgreementId", name: "AgreementId", title: "Id" }, { data: "AgreementNumber", name: "AgreementNumber", title: "Номер" }, { data: "LastName", name: "LastName", title: "Фамилия" }, { data: "FirstName", name: "FirstName", title: "Имя" }, { data: "Patronymic", name: "Patronymic", title: "Отчество" }, { data: "ProductCode", name: "ProductCode", title: "Код продукта" }, { data: "Inn", name: "Inn", title: "ИНН" }, { data: "Dpd", name: "Dpd", title: "Дней просрочки" }, { data: "Outstanding", name: "Outstanding", title: "Сумма просрочки" }, { data: "Currency", name: "Currency", title: "Валюта" }],
                "ajax": {
