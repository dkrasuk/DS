define([], function () {
    ...
    app.utils = function () {
        ...
        var utils = {
            urlContent: function urlContent(url) {
            ...
            ui: {
                loader: function loader(element, enable, options) {
        ...
        utils.ui.dialog = function (options) {
            ...
            var modalSizeClass = function modalSizeClass(width) {
                if (width < 768) {
                    return 'modal-sm';
                }
                if (width <= 992) {
            ...
            var buildModalButtons = function buildModalButtons(buttons) {
                if (buttons) {
        ...
        utils.ui.prompt = function (options, func) {
            ...
            if (options.inputType === 'date') {
                ...
                options.open = function () {
                    $(this).find('#utilsUiPromptDialogInput').datetimepicker({
                        format: 'd/m/Y',
                        lang: 'uk',
                        timepicker: false,
                        dayOfWeekStart: 1
                    }).mask("99/99/9999", { placeholder: "__/__/____" }).removeAttr("data-val-date");
                    if (oldOpen) {
                        oldOpen.call(this);
                    }
                };
        ...
        utils.dataTable = {
            bindGridButtons: function bindGridButtons(mainGrid) {
                ...
                var tableWrapper = $(mainGrid[0]).parentsUntil('.dataTables_wrapper').parent();
